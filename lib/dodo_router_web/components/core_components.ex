defmodule DodoRouterWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DodoRouterWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DodoRouterWeb.Gettext, "errors", msg, opts)
    end
  end
