defmodule DodoRouterWeb.ProviderIcons do
  @moduledoc """
  Shared provider icon components and helpers.
  """
  ...
  @doc """
  Renders a provider logo SVG given a key slug.
  Falls back to a generic server icon for unknown slugs.
  """
  ...
  def provider_logo(assigns) do
    ...
    <%= case normalize_slug(@slug) do %>
      ...
      <% _ -> %>
        <.icon name="hero-server" class={"size-4 text-base-content/50 #{@class}"} />
    <% end %>
    """
  end

  @doc """
  Returns a Tailwind background color class for a provider color name.
  """
  def provider_bg("emerald"), do: "bg-emerald-100"
  def provider_bg("green"), do: "bg-green-100"
  def provider_bg("amber"), do: "bg-amber-100"
  def provider_bg("blue"), do: "bg-blue-100"
  def provider_bg("purple"), do: "bg-purple-100"
  def provider_bg("orange"), do: "bg-orange-100"
  def provider_bg("cyan"), do: "bg-cyan-100"
  def provider_bg("coral"), do: "bg-rose-100"
  def provider_bg("slate"), do: "bg-slate-100"
  def provider_bg(_), do: "bg-secondary"

  @doc """
  Normalizes a provider key slug to its parent icon key.
  """
