defmodule DodoRouterWeb do
  ...
  def controller do
    quote do
      ...
      use Gettext, backend: DodoRouterWeb.Gettext
  ...
  defp html_helpers do
    quote do
      ...
      import DodoRouterWeb.DiffComponents

      # Common modules used in templates
      alias Phoenix.LiveView.JS
      alias DodoRouterWeb.Layouts
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: DodoRouterWeb.Router,
        statics: DodoRouterWeb.static_paths()
    end
  end
